...
router.register('notification-automations', views.NotificationAutomationViewSet, basename='admin-notification-automation')
router.register('tips', views.MoneyTipViewSet, basename='admin-tip')
router.register('feed', views.FeedPostViewSet, basename='admin-feed')
