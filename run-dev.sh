...
#./run-dev.sh   // for local development
...
echo "==> Starting Expo (mobile) on http://127.0.0.1:8083 ..."
cd "$ROOT/mobile"
# Simulator must use 127.0.0.1 — LAN IPs often fail from the iOS sim.
export REACT_NATIVE_PACKAGER_HOSTNAME=127.0.0.1
npx expo start --dev-client --port 8083 --ios
